...
const MANUAL_DATA = {
    ...
    '1f9d1-200d-2640-fe0f-200d-1f9af-200d-27a1-fe0f': {
        name: 'woman_with_probing_cane_facing_right',
        cat: 'People & Body',
    },
    '1f9d1-200d-2642-fe0f-200d-1f9af-200d-27a1-fe0f': {
        name: 'man_with_probing_cane_facing_right',
        cat: 'People & Body',
    },
    ...
    '1f9d1-200d-2640-fe0f-200d-1f9bc-200d-27a1-fe0f': {
        name: 'woman_in_manual_wheelchair_facing_right',
        cat: 'People & Body',
    },
    '1f9d1-200d-2642-fe0f-200d-1f9bc-200d-27a1-fe0f': {
    ...
    '1f9d1-200d-2640-fe0f-200d-1f9bd-200d-27a1-fe0f': {
        name: 'woman_in_motorized_wheelchair_facing_right',
        cat: 'People & Body',
    },
    '1f9d1-200d-2642-fe0f-200d-1f9bd-200d-27a1-fe0f': {
...
for (const file of files) {
    ...
    const g = gemoji.find((item) => {
        try {
            return (
                item.emoji === String.fromCodePoint(...hex.split('-').map((h) => parseInt(h, 16)))
            );
        } catch (e) {
            return false;
        }
    ...
    if (MANUAL_DATA[hex]) {
        ...
        name =
            g.aliases && g.aliases.length > 0
                ? g.aliases[0]
                : g.description.replace(/ /g, '_').toLowerCase();
        cat = g.category;
    }
...
fs.writeFileSync(
    'pages/static/js/emojiList.js',
    'window.EMOJI_CATEGORIES = ' + JSON.stringify(finalCategories) + ';'
);
