exports.toggleImages = async function toggleImages(req, res) {
    try {
        ...
        if (parsedUrlImages !== null && (isNaN(parsedUrlImages) || (parsedUrlImages !== 0 && parsedUrlImages !== 1))) {
            parsedUrlImages = null;
        }
        const currentValue = parsedUrlImages !== null ? parsedUrlImages : (imagesCookie !== undefined ? parseInt(imagesCookie) : 1);
        ...
        res.writeHead(302, { 'Set-Cookie': [`images=${newValue}; path=/`], "Content-Type": "text/html", "Location": location});
        res.end();
    } catch (error) {
