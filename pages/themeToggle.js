exports.toggleTheme = async function toggleTheme(req, res) {
    try {
        ...
        if (parsedUrlTheme !== null && (isNaN(parsedUrlTheme) || parsedUrlTheme < 0 || parsedUrlTheme > 2)) {
            parsedUrlTheme = null;
        }
        const currentTheme = parsedUrlTheme !== null ? parsedUrlTheme : (whiteThemeCookie !== undefined ? parseInt(whiteThemeCookie) : 0);
        ...
        res.writeHead(302, { 'Set-Cookie': [`whiteThemeCookie=${nextTheme}; path=/`], "Content-Type": "text/html", "Location": location});
        res.end();
    } catch (error) {
