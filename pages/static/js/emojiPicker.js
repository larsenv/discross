'use strict';
(function() {
    var quickNames = ['sob', 'skull', 'pleading_face', 'heart', 'joy', 'fire', 'white_check_mark', 'eyes'];
    ...
    function createEmojiElement(emoji, isCustom, animated) {
        ...
        if (typeof setHoverBg === 'function') {
            a.onmouseover = function() { setHoverBg(this); };
            a.onmouseout = function() { clearBg(this); };
        } else {
            a.onmouseover = function() { this.style.backgroundColor = 'rgba(255, 255, 255, 0.1)'; };
        ...
        if (isCustom) {
            img.src = "https://cdn.discordapp.com/emojis/" + code + (animated ? ".gif" : ".png") + "?size=48";
        } else {
